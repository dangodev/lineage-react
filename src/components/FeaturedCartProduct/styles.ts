...
const textColors: { [key: string]: string } = {
  ...
  cadet: `rgb(${color.black})`,
  gray: `rgb(${color.black})`,
  grayTT: `rgb(${color.white})`,
  green: `rgb(${color.white})`,
  offwhite: `rgb(${color.black})`,
...
export const Label = styled.div<{ color: keyof typeof color }>`
  background-color: rgb(${props => color[props.color]});
