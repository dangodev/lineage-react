...
const thisYear = new Date().getUTCFullYear() || '2018';

const Footer = () => (
  <Styled.Container>
    <Styled.Nav>
      <Styled.MainNav>
        <Styled.StyledLink to={COLLECTION.coffee}>Coffee</Styled.StyledLink>
        <Styled.StyledLink to={COLLECTION.gear}>Gear</Styled.StyledLink>
        <Styled.StyledLink to={PAGE.wholesale}>Wholesale</Styled.StyledLink>
        <Styled.StyledLink to={PAGE.about}>About</Styled.StyledLink>
        <Styled.StyledLink to={PAGE.learn}>Learn</Styled.StyledLink>
      </Styled.MainNav>
      <Styled.SocialNav>
    ...
    <Styled.Colophon>
      ...
      <Styled.Copyright>
        © {thisYear} Lineage Coffee Roasting. We do not share your information without your
