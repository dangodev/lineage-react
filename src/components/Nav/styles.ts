...
export const CartLink = styled(NavLink)<{ empty: boolean }>`
  align-items: center;
...
export const LinkList = styled.nav<{ isOpen: boolean }>`
  align-items: center;
...
export const MobileLink = styled(Link)<{ isOpen: boolean }>`
  display: block;
...
export const MobileOpen = styled.button<{ isOpen: boolean }>`
  align-items: center;
  appearance: button;
  background: none;
  border: 0;
