...
export const transition = {
  ...transitions,
  default: transitions.fastOutSlowIn,
  sharp: transitions.fastOutLinearIn,
  acceleration: transitions.fastOutLinearIn,
  deceleration: transitions.linearOutSlowIn,
  standard: transitions.fastOutSlowIn,
};
