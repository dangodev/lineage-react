...
class ProductContainer extends React.Component {
  ...
  route(nextProps) {
    ...
    if (nextProps.match.url === "/products") {
      ...
      const nextProduct = nextProps.allProducts.find(
        ({ handle }) => handle === subroute
      );
        ...
        this.setState({
          collection: nextProps.collections.find(collection =>
            collection.products.find(
              product => product.handle === nextProduct.handle
            )
          )
        });
      }
    ...
    return (
      <div>
        ...
        <Collection
          ...
          isShowing={
            this.state.current === "collections" ||
            this.state.current === "products"
          }
